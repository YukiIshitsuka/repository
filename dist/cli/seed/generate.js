...
if (typeof require !== "undefined" && require.main === module) {
    // optionをたす場合はここにたす。
    color_1.ColorConsole.info("seed generate start");
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    seedName = program.file;
                                    return [4 /*yield*/, seed_1.Seed.generate(seedName)];
                                case 1:
                                    _a.sent();
                                    color_1.ColorConsole.success(seedName + " seed generate!!");
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
